...
namespace TTI.Buffalo.ApiRest.Service;

public static class HostingExtensions
{
    public static PassportOptions passportOptions = new();

    public static void CloudBuffaloConfigureServices(this WebApplicationBuilder builder)
    {
    ...
    public static async Task CloudBuffaloConfigureApplication(this WebApplication app)
    {
